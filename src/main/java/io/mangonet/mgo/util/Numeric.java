...
import io.mangonet.mgo.protocol.exceptions.MessageDecodingException;
import io.mangonet.mgo.protocol.exceptions.MessageEncodingException;
...
public class Numeric {
    ...
    public static byte[] base58ToBytes(String base58) {
        ...
        try {
            // For Mgo digest, usually uses Base64 encoding
