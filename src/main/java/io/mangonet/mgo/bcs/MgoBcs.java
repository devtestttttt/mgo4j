...
import io.mangonet.mgo.bcs.types.arg.object.*;
import io.mangonet.mgo.bcs.types.arg.object.*;
...
public class MgoBcs {
    ...
    public static final BcsSerializer.BcsTypeSerializer<String> ADDRESS_SERIALIZER = (serializer, address) -> {
        // verify address
        if (!isValidMgoAddress(ObjectIdUtil.normalizeMgoAddress(address))) {
            throw new IllegalArgumentException("Invalid Mgo address: " + address);
        }
    ...
    /**
     * MgoObjectRef serializer
     */
    public static final BcsSerializer.BcsTypeSerializer<MgoObjectRef> MGO_OBJECT_REF_SERIALIZER = (serializer, ref) -> {
    ...
    public static final BcsSerializer.BcsTypeSerializer<ObjectArg> OBJECT_ARG_SERIALIZER = (serializer, arg) -> {
        if (arg instanceof ObjectArgImmOrOwnedObject) {
            ...
            MGO_OBJECT_REF_SERIALIZER.serialize(serializer, ((ObjectArgImmOrOwnedObject) arg).getObjectRef());
            ...
            MGO_OBJECT_REF_SERIALIZER.serialize(serializer, ((ObjectArgReceiving) arg).getObjectRef());
        } else {
    ...
    public static final BcsSerializer.BcsTypeSerializer<GasData> GAS_DATA_SERIALIZER = (serializer, gasData) -> {
        serializer.writeVector(gasData.getPayment(), MGO_OBJECT_REF_SERIALIZER);
    ...
    public static final BcsSerializer.BcsTypeSerializer<AppId> APP_ID_SERIALIZER = (serializer, appId) -> {
        if (appId instanceof AppId.Mgo) {
            serializer.writeU8((byte) 0); // Mgo variant
        } else {
    ...
    /**
     * MgoObjectRef deserializer
     */
    public static final BcsDeserializer.BcsTypeDeserializer<MgoObjectRef> MGO_OBJECT_REF_DESERIALIZER = (deserializer) -> {
        ...
        return new MgoObjectRef(address, version, digest);
    };
    ...
    public static final BcsDeserializer.BcsTypeDeserializer<ObjectArg> OBJECT_ARG_DESERIALIZER = (deserializer) -> {
        ...
        return switch (flag) {
            case (byte) 0 -> new ObjectArgImmOrOwnedObject(MGO_OBJECT_REF_DESERIALIZER.deserialize(deserializer));
            case (byte) 1 -> new ObjectArgSharedObject(SHARED_OBJECT_REF_DESERIALIZER.deserialize(deserializer));
            case (byte) 2 -> new ObjectArgReceiving(MGO_OBJECT_REF_DESERIALIZER.deserialize(deserializer));
    ...
    public static CallArgObjectArg deserializeObjectArg(BcsDeserializer deserializer) throws IOException {
        byte flag = deserializer.readU8();
        return switch (flag) {
            case (byte) 0 -> new CallArgObjectArg(new ObjectArgImmOrOwnedObject(MGO_OBJECT_REF_DESERIALIZER.deserialize(deserializer)));
            case (byte) 1 -> new CallArgObjectArg(new ObjectArgSharedObject(SHARED_OBJECT_REF_DESERIALIZER.deserialize(deserializer)));
            case (byte) 2 -> new CallArgObjectArg(new ObjectArgReceiving(MGO_OBJECT_REF_DESERIALIZER.deserialize(deserializer)));
     ...
     */
    public static final BcsDeserializer.BcsTypeDeserializer<TypeTag> TYPE_TAG_DESERIALIZER = MgoBcs::deserializeTypeTag;
     ...
     */
    public static final BcsDeserializer.BcsTypeDeserializer<TypeTagStructTag> STRUCT_TAG_DESERIALIZER = MgoBcs::deserializeStructTag;
    ...
    public static final BcsDeserializer.BcsTypeDeserializer<GasData> GAS_DATA_DESERIALIZER = (deserializer) -> new GasData(
            deserializer.readVector(MGO_OBJECT_REF_DESERIALIZER),
    ...
    public static final BcsDeserializer.BcsTypeDeserializer<AppId> APP_ID_DESERIALIZER = (deserializer) -> {
        byte flag = deserializer.readU8();
        if (flag == (byte) 0) {
            return AppId.Mgo.INSTANCE; // V0 variant
        } else {
    ...
    /**
     * Validate if the Mgo address is valid.
     */
    public static boolean isValidMgoAddress(String address) {
        if (address == null || address.isEmpty()) {
            return false;
        }
        
        String normalized = ObjectIdUtil.normalizeMgoAddress(address);
