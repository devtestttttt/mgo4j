...
public class MgoCallArgDeserializer extends StdDeserializer<MgoCallArg> {

    public MgoCallArgDeserializer() {
        super(MgoCallArg.class);
    }

    @Override
    public MgoCallArg deserialize(JsonParser p, DeserializationContext ctxt)
            throws IOException {
    ...
    private MgoCallArg handleObjectType(JsonNode root, JsonParser p)
    ...
    private MgoCallArg handlePureType(JsonNode root, JsonParser p)
