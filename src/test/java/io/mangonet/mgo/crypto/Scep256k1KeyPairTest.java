...
public class Scep256k1KeyPairTest {
    ...
    private static final String EXPECTED_ADDRESS =
            "0xd28fc909de7ebeae167de426270e319458c08f5b4b5484afea32ea582294378a";
    private static final String TEST_MESSAGE = "hello_mgo_secp256k1";

    @Test
    void createMgoKeyPair() {
        // When
        MgoKeyPair<ECKey> keyPair = Secp256k1KeyPair.generate();
...
//
//        // When
//        MgoKeyPair<?> keyPair = Secp256k1KeyPair.decodeBase64(encoded);
//
//        // Then
//        assertThat(keyPair)
//                .isInstanceOf(Secp256k1KeyPair.class)
//                .extracting(MgoKeyPair::signatureScheme)
