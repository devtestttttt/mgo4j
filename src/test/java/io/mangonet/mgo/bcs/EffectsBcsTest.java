...
public class EffectsBcsTest {
    ...
    private List<MgoObjectRef> testObjects;
    ...
    void setUp() {
        ...
        testObjects = Arrays.asList(
            new MgoObjectRef("0x0b50fe6d7b86730f0f8d2e389d22d63c30a73a1034720a8a43bb5e322a9588e1", 1L, HashUtil.sha256Base58("digest1")),
            new MgoObjectRef("0xfcf8ed6af43ddd6b21299fc1766dcea3a0fd16edac0bc38ebb114a20bc7d4da3", 2L, HashUtil.sha256Base58("digest2"))
        );
    ...
    void testLargeObjectLists() throws IOException {
        ...
        List<MgoObjectRef> largeList = Arrays.asList(
            new MgoObjectRef("0x1111111111111111111111111111111111111111111111111111111111111111", 1L, HashUtil.sha256Base58("digest1")),
            new MgoObjectRef("0x2222222222222222222222222222222222222222222222222222222222222222", 2L, HashUtil.sha256Base58("digest2")),
            new MgoObjectRef("0x3333333333333333333333333333333333333333333333333333333333333333", 3L, HashUtil.sha256Base58("digest3")),
            new MgoObjectRef("0x4444444444444444444444444444444444444444444444444444444444444444", 4L, HashUtil.sha256Base58("digest4")),
            new MgoObjectRef("0x5555555555555555555555555555555555555555555555555555555555555555", 5L, HashUtil.sha256Base58("digest5"))
        );
    ...
    void testRoundTripSerialization() throws IOException {
        ...
        List<MgoObjectRef> complexObjects = Arrays.asList(
            new MgoObjectRef("0x" + "a".repeat(64), Long.MAX_VALUE, HashUtil.sha256Base58("very_long_digest_string_here")),
            new MgoObjectRef("0x" + "b".repeat(64), 0L, HashUtil.sha256Base58("short_digest"))
        );
