...
import io.mangonet.mgo.bcs.types.arg.object.ObjectArgReceiving;
...
import io.mangonet.mgo.bcs.types.tag.*;
import io.mangonet.mgo.protocol.MgoClientTest;
import io.mangonet.mgo.util.HashUtil;
...
@Slf4j
public class MgoBcsTest extends MgoClientTest {

    private MgoObjectRef mgoObjectRef;
    ...
    @BeforeEach
    void init() {
        // Create a Mgo object reference for testing purposes.
        mgoObjectRef = new MgoObjectRef("0x0000000000000000000000000000000000000000000000001234567890abcdef", 1L, HashUtil.sha256Base58("digest123"));
        ...
        immOrOwnedObject = new ObjectArgImmOrOwnedObject(mgoObjectRef);
        sharedObject = new ObjectArgSharedObject(sharedObjectRef);
        receivingObject = new ObjectArgReceiving(mgoObjectRef);
    ...
    @Test
    void testMgoObjectRefSerialization() throws IOException {
        log.info("Testing MgoObjectRef serialization...");

        BcsSerializer serializer = new BcsSerializer();
        MgoBcs.MGO_OBJECT_REF_SERIALIZER.serialize(serializer, mgoObjectRef);
        String base64 = serializer.toBase64();

        log.info("MgoObjectRef: objectId={}, version={}, digest={}",
                mgoObjectRef.getObjectId(), mgoObjectRef.getVersion(), mgoObjectRef.getDigest());
        ...
        assertEquals(mgoObjectRef.getObjectId(), objectId);
        assertEquals(mgoObjectRef.getVersion(), version);
        assertEquals(mgoObjectRef.getDigest(), digest);
    }
    ...
    void testSharedObjectRefSerialization() throws IOException {
        ...
        BcsSerializer serializer = new BcsSerializer();
        MgoBcs.SHARED_OBJECT_REF_SERIALIZER.serialize(serializer, sharedObjectRef);
        String base64 = serializer.toBase64();
    ...
    void testObjectArgImmOrOwnedObjectSerialization() throws IOException {
        ...
        BcsSerializer serializer = new BcsSerializer();
        MgoBcs.OBJECT_ARG_SERIALIZER.serialize(serializer, immOrOwnedObject);
        String base64 = serializer.toBase64();

        log.info("ObjectArgImmOrOwnedObject: has MgoObjectRef");
        log.info("Serialized Base64: {}", base64);
    ...
    void testObjectArgSharedObjectSerialization() throws IOException {
        ...
        BcsSerializer serializer = new BcsSerializer();
        MgoBcs.OBJECT_ARG_SERIALIZER.serialize(serializer, sharedObject);
        String base64 = serializer.toBase64();
    ...
    void testObjectArgReceivingSerialization() throws IOException {
        ...
        BcsSerializer serializer = new BcsSerializer();
        MgoBcs.OBJECT_ARG_SERIALIZER.serialize(serializer, receivingObject);
        String base64 = serializer.toBase64();

        log.info("ObjectArgReceiving: has MgoObjectRef");
        log.info("Serialized Base64: {}", base64);
    ...
    void testCallArgPureSerialization() throws IOException {
        ...
        BcsSerializer serializer = new BcsSerializer();
        MgoBcs.CALL_ARG_SERIALIZER.serialize(serializer, callArgPure);
        String base64 = serializer.toBase64();
    ...
    void testCallArgObjectArgSerialization() throws IOException {
        ...
        BcsSerializer serializer = new BcsSerializer();
        MgoBcs.CALL_ARG_SERIALIZER.serialize(serializer, callArgObject);
        String base64 = serializer.toBase64();
    ...
    void testTypeTagSerialization() throws IOException {
        ...
        for (TypeTag typeTag : typeTags) {
            BcsSerializer serializer = new BcsSerializer();
            MgoBcs.TYPE_TAG_SERIALIZER.serialize(serializer, typeTag);
            String base64 = serializer.toBase64();
    ...
    void testSerializeToBase64() throws IOException {
        ...
        String base64 = MgoBcs.serializeToBase64(mgoObjectRef, MgoBcs.MGO_OBJECT_REF_SERIALIZER);

        log.info("MgoObjectRef serialized to Base64: {}", base64);
    ...
    void testComplexTypeTagSerialization() throws IOException {
        ...
        BcsSerializer serializer = new BcsSerializer();
        MgoBcs.TYPE_TAG_SERIALIZER.serialize(serializer, typeTagVector);
        String base64 = serializer.toBase64();
    ...
    void testLargeArgumentsList() throws IOException {
        ...
        for (int i = 0; i < largeArguments.size(); i++) {
            ...
            BcsSerializer serializer = new BcsSerializer();
            MgoBcs.CALL_ARG_SERIALIZER.serialize(serializer, arg);
            String base64 = serializer.toBase64();
    ...
    void testInvalidBase64Deserialization() {
        ...
        assertThrows(DecoderException.class, () -> {
            MgoBcs.deserializeFromBase64("invalid_base64_string", deserializer -> null);
        });

        // test null string
//        assertThrows(IllegalArgumentException.class, () -> {
//            MgoBcs.deserializeFromBase64("", deserializer -> null);
//        });

        // test null
        assertThrows(NullPointerException.class, () -> {
            MgoBcs.deserializeFromBase64(null, deserializer -> null);
        });
    }
    ...
    void testRoundTripSerialization() throws IOException {
        ...
        MgoObjectRef complexObjectRef = new MgoObjectRef(
                "0x" + "a".repeat(64), Long.MAX_VALUE, HashUtil.sha256Base58("very_long_digest_string_here")
        );

        // serialize
        String base64 = MgoBcs.serializeToBase64(complexObjectRef, MgoBcs.MGO_OBJECT_REF_SERIALIZER);
        log.info("Complex MgoObjectRef serialized to Base64: {}", base64);
        ...
        log.info("Complex MgoObjectRef serialized successfully");
    }
    ...
    void testSpecialCharactersInStrings() throws IOException {
        ...
        MgoObjectRef specialObjectRef = new MgoObjectRef(
                "0x000000000000000000000000000000000000000000000000fedcba0987654321",
                Long.MAX_VALUE,
                HashUtil.sha256Base58("digest_with_special_chars_!@#$%^&*()0x!@#$%^&*()_+-=[]{}|;':\",./<>?")
        );

        String base64 = MgoBcs.serializeToBase64(specialObjectRef, MgoBcs.MGO_OBJECT_REF_SERIALIZER);
        log.info("Special characters MgoObjectRef serialized to Base64: {}", base64);
